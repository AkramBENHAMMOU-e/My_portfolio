  ...
  return <section className="py-24 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedProjects.map((project, index) => <Card key={index} className={`group hover:shadow-glow-secondary transition-all duration-300 hover:scale-105 ${project.featured ? 'border-primary/50' : ''}`}>
        ...
        <div className="text-center mt-12">
          <Button variant="outline" size="lg" onClick={() => setShowAllProjects(!showAllProjects)}>
